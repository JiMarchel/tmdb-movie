...
export const MovieDetail = ({
  ...
  const tabsContents = [
    ...
    {
      value: "similar",
      content: <MoviesCard datas={similarData} loading={loading} />,
    },
  ];
  ...
  return (
    <Wrapper className="mx-2 sm:max-w-2xl sm:mx-auto md:max-w-4xl lg:max-w-6xl">
        ...
        <div className="grid grid-cols-2 mx-1 items-end sm:h-full">
          <div className="flex flex-col ml-2 gap-2 sm:mb-10 lg:ml-6">
            ...
            <div className="flex items-center gap-2 text-xs font-light">
              <p className="border-r border-white pr-2">{data?.release_date}</p>
              <p>{data?.status}</p>
            </div>
      ...
      <div className="hidden sm:flex mt-5">
        <CarouselSimilarShows similarMovies={similarData} loading={loading} />
      </div>
      ...
      <Tabs defaultValue="overview" className="sm:hidden">
        <TabsList>
          ...
          <TabsTrigger value="similar">Similar Movie</TabsTrigger>
        </TabsList>
